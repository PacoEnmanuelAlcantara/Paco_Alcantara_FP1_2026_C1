...
void Lectura(vendedor A[], int T)
{
    ...
    for (I = 0; I < T; I++) {
        ...
        scanf(" %19[^\n]", A[I].domi.cnu);
        printf("\tColonia: ");
        scanf("%19s", A[I].domi.col);
        printf("\tCodigo Postal: ");
        scanf("%4s", A[I].domi.cp);
        printf("\tCiudad: ");
        scanf("%14s", A[I].domi.ciu);
        ...
        switch (A[I].cla) {
            case 1:
                ...
                scanf("%9s", A[I].pago.che.noba);
                printf("\tNumero de cuenta: ");
                scanf("%9s", A[I].pago.che.nucu);
                break;
            case 2:
                printf("\tNombre del banco: ");
                scanf("%9s", A[I].pago.nomi.noba);
                printf("\tNumero de cuenta: ");
                scanf("%9s", A[I].pago.nomi.nucu);
                break;
            case 3:
                A[I].pago.venta = 'S';
                break;
